...
class MLP(nn.Module):
    def __init__(self, channel, num_classes):
        ...
        # self.fc_1 = nn.Linear(28*28*1 if channel==1 else 28*28*3, 128)
...
class AlexNetBN(nn.Module):
    def __init__(self, channel, num_classes):
        ...
        self.fc = nn.Linear(192 * 4 * 4, num_classes)
        self.fc = nn.Linear(1728, num_classes) ###Multi
...
class VGG(nn.Module):
    def __init__(self, vgg_name, channel, num_classes, norm='instancenorm'):
        ...
        # self.classifier = nn.Linear(8192 if vgg_name != 'VGGS' else 128, num_classes) ###Multi
